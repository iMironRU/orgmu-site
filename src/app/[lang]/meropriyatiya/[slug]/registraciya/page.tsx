...
import RuPage, { generateStaticParams as ruParams } from "@/app/meropriyatiya/[slug]/registraciya/page";
import { TARGET_LOCALES, isTargetLocale } from "@/lib/i18n/config";
import { alternatesFor } from "@/lib/i18n/alternates";

// Зеркало русской страницы регистрации под языковым адресом. Список адресов
// берём у самой русской страницы — второго источника правды заводить нельзя.
...
export async function generateMetadata({
  ...
  const ru = `/meropriyatiya/${slug}/registraciya`;
