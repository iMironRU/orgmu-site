...
// Оглавление разделов ОДНОЙ страницы: подсветка текущего при скролле, плавная
// прокрутка со смещением под шапку, на мобиле — селект.
// Панель называется «Разделы» везде: раньше было три названия для одного и
// того же («Разделы», «Содержание», «В разделе») — человек гадал, одно ли это.
// Навигацию МЕЖДУ страницами делает PageNav, и у неё названия свои по смыслу
// («Подразделы», «Приложения») — это осознанно другая сущность.
