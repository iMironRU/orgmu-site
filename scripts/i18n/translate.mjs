...
const SOURCES = [
  ...
  // Строки из данных, которые собираются кодом (оргструктура, персоны):
  // выгружает scripts/i18n/export-strings.ts, см. комментарий в нём.
  "content/i18n/data-strings.json",
];
